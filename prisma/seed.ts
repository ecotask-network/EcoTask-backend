...
const SAMPLE_TASKS = [
  ...
  {
    title: 'Plant Native Trees in Greenfield',
    description:
  ...
  {
    title: 'Recycling Drive - Downtown Hub',
    description:
  ...
  {
    title: 'Beach Cleanup at Brighton Shore',
    description:
  ...
  {
    title: 'Trail Maintenance - Pine Ridge',
    description:
