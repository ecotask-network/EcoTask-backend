...
ALTER TABLE "User" ADD COLUMN "validator_reputation" INTEGER NOT NULL DEFAULT 0;
ALTER TABLE "User" ADD COLUMN "review_count" INTEGER NOT NULL DEFAULT 0;
...
ALTER TABLE "validator_votes" ADD CONSTRAINT "validator_votes_validator_id_fkey" FOREIGN KEY ("validator_id") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
