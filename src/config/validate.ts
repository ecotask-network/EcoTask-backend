...
export function validateEnv(): EnvConfig {
  ...
  if (!result.success) {
    ...
    validatedEnv = envSchema.parse({
      ...process.env,
      DATABASE_URL: process.env.DATABASE_URL || "postgresql://ecotask:ecotask@localhost:5432/ecotask",
      JWT_SECRET: process.env.JWT_SECRET || "dev-secret-change-in-production-at-least-16chars",
    });
    return validatedEnv;
  }
